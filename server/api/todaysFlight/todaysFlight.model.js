...
export default function(sequelize, DataTypes) {
  return sequelize.define('TodaysFlight', {
    ...
    crewId:DataTypes.STRING,
    cockpitInspection:DataTypes.STRING,
    cabinInspection:DataTypes.STRING,
    cargoInspection:DataTypes.STRING,
    wheelWellInspection:DataTypes.STRING,
