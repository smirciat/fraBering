...
exports = module.exports = {
  ...
  flights:[
    ...
    {  flightNum:'850', airports:['PAOM','PAGM','PASA'], daysOfWeek:[1,2,3,4,5,6], departTimes:['9:00','10:00','10:30']},
    {  flightNum:'852', airports:['PAOM','PAGM','PASA'], daysOfWeek:[7], departTimes:['13:30','14:30','15:00']},
    {  flightNum:'853', airports:['PAOM','PAGM','PASA'], daysOfWeek:[1,2,3,4,5,6], departTimes:['15:00','16:05','16:35']},  
