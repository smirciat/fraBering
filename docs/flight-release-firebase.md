...
**Locked (18 Sep 2026).** Proven extra **6850**, PFR **`933-091826-17`**: dispatch-only omitted PIC; PIC merge kept dispatch Timestamp and added PIC Timestamp.
...
| Signatures | **Only names that are set** + matching timestamps as **JS Date** (Firestore Timestamp) |
